<div class="p-6 sm:px-20 bg-white border-b border-gray-200">
    ...
    <div class="mt-6 text-gray-500">
        Fpoly Restaurant là hệ thống quản lý nhà hàng được thành lập vào năm 2022
        tại thành phố Hồ Chí Minh, Việt Nam, tạo ra nhằm mục đích phát triển kinh doanh, quản lý nhân sự. Thực hiện bởi sinh viên trường FPT
    </div>
</div>
...
<div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2">
    ...
    <div class="p-6 border-t border-gray-200 md:border-t-0 md:border-l">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="{{route('employees')}}">Quản lí nhân viên</a></div>
        </div>
    ...
    <div class="p-6 border-t border-gray-200">
        <div class="flex items-center">
            ...
            <div class="ml-4 text-lg text-gray-600 leading-7 font-semibold"><a href="{{route('partners.index')}}">Quản lý đơn hàng</a></div>
        </div>

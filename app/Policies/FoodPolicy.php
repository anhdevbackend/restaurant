...
class FoodPolicy
{
    ...
    {
        return $user->hasPermissions(Permission::R.'foods');
    }
    ...
    {
        return $user->hasPermissions(Permission::C.'foods');
    }
    ...
    {
        return $user->hasPermissions(Permission::U.'foods');
    }
    ...
    {
        return $user->hasPermissions(Permission::D.'foods');
    }
